...
local theme = lush(function()
  return {
    ...
    -- MoreMsg      { }, -- |more-prompt|
    NonText      { fg = c.grey_4, bg = 'none' }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    Normal       {bg = 'none', bg = 'none', fg = c.dark_fg_256mod}, -- normal text
